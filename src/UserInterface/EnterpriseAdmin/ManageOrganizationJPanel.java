...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (OrganizationType type : Organization.OrganizationType.values()){
            if (!type.getValue().equals(OrganizationType.Admin.getValue())&& 
                    !type.getValue().equals(OrganizationType.SysAdmin.getValue()) && 
                    !type.getValue().equals(OrganizationType.Customer.getValue()) && 
                    !type.getValue().equals(OrganizationType.AmazonFinance.getValue())&&
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if(type.getValue().equals(OrganizationType.SupplierFinance.getValue())){
        
        }
        
        JOptionPane.showMessageDialog(null, type + " Organization has been created!!");
        populateTable();
