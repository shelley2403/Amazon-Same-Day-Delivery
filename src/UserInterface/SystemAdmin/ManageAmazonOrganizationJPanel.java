...
public class ManageAmazonOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageAmazonOrganizationJPanel(JPanel userProcessContainer,EcoSystem system) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        for (OrganizationType type : Organization.OrganizationType.values()){
            if (type.getValue().equals(OrganizationType.AmazonFinance.getValue())||
                    type.getValue().equals(OrganizationType.AmazonOrder.getValue()))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(41, 41, 41)
                        .addComponent(manageEmployeeJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void manageEmployeeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeeJButtonActionPerformed
        // TODO add your handling code here:
        ManageAmazonEmployeeJPanel maeJPanel = new ManageAmazonEmployeeJPanel(userProcessContainer, system);
        userProcessContainer.add("ManageAmazonEmployeeJPanel", maeJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
